...
public class XYDataSeriesSEPAF<E, K, X, P> extends AbstractSingleEPAF<E, XYDataSeriesPlot, K, List<XYDataSeries>, X> {
  ...
  @Override
  protected List<Map.Entry<String, List<XYDataSeries>>> buildData(E e, K k) {
    return List.of(
        Map.entry(
            "",
