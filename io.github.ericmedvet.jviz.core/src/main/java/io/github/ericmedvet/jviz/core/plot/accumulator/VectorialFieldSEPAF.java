...
public class VectorialFieldSEPAF<E, K, X, F> extends AbstractSingleEPAF<E, VectorialFieldPlot, K, List<VectorialFieldDataSeries>, X> {
  ...
  @Override
  protected List<Map.Entry<String, List<VectorialFieldDataSeries>>> buildData(E e, K k) {
