...
public class KAggregatedXYDataSeriesMKPAF<E, K, L> extends AggregatedXYDataSeriesMKPAF<E, K, L> {
  private final Function<? super K, ? extends Number> xFunction;

  public KAggregatedXYDataSeriesMKPAF(
      ...
      DoubleRange xRange,
      DoubleRange yRange,
      Function<? super K, ? extends Number> xFunction
  ) {
    super(
        xSubplotFunction,
        ySubplotFunction,
