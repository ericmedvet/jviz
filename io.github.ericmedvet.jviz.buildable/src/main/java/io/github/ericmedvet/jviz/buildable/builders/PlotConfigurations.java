...
import io.github.ericmedvet.jviz.core.plot.image.Configuration.TrajectoryPlot;
...
public class PlotConfigurations {
  ...
  public static Configuration image(
    ...
    return new Configuration(
        ...
        new TrajectoryPlot(
            TrajectoryPlot.DEFAULT.startMarker(),
            TrajectoryPlot.DEFAULT.midMarker(),
            TrajectoryPlot.DEFAULT.endMarker(),
            TrajectoryPlot.DEFAULT.strokeSizeRate() * strokeSizeRate,
            TrajectoryPlot.DEFAULT.markerSizeRate() * markerSizeRate,
            TrajectoryPlot.DEFAULT.legendImageXRate(),
            TrajectoryPlot.DEFAULT.legendImageYRate(),
            TrajectoryPlot.DEFAULT.colors(),
            TrajectoryPlot.DEFAULT.xExtensionRate(),
